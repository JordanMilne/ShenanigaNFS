...
class NFS_PROGRAM_3_CLIENT(client.BaseClient):
    ...
    async def GETATTR(self, arg_0: v_GETATTR3args) -> client.UnpackedRPCMsg[v_GETATTR3res]:
        return await self.send_call(1, arg_0)

    async def SETATTR(self, arg_0: v_SETATTR3args) -> client.UnpackedRPCMsg[v_SETATTR3res]:
        return await self.send_call(2, arg_0)

    async def LOOKUP(self, arg_0: v_LOOKUP3args) -> client.UnpackedRPCMsg[v_LOOKUP3res]:
        return await self.send_call(3, arg_0)

    async def ACCESS(self, arg_0: v_ACCESS3args) -> client.UnpackedRPCMsg[v_ACCESS3res]:
        return await self.send_call(4, arg_0)

    async def READLINK(self, arg_0: v_READLINK3args) -> client.UnpackedRPCMsg[v_READLINK3res]:
        return await self.send_call(5, arg_0)

    async def READ(self, arg_0: v_READ3args) -> client.UnpackedRPCMsg[v_READ3res]:
        return await self.send_call(6, arg_0)

    async def WRITE(self, arg_0: v_WRITE3args) -> client.UnpackedRPCMsg[v_WRITE3res]:
        return await self.send_call(7, arg_0)

    async def CREATE(self, arg_0: v_CREATE3args) -> client.UnpackedRPCMsg[v_CREATE3res]:
        return await self.send_call(8, arg_0)

    async def MKDIR(self, arg_0: v_MKDIR3args) -> client.UnpackedRPCMsg[v_MKDIR3res]:
        return await self.send_call(9, arg_0)

    async def SYMLINK(self, arg_0: v_SYMLINK3args) -> client.UnpackedRPCMsg[v_SYMLINK3res]:
        return await self.send_call(10, arg_0)

    async def MKNOD(self, arg_0: v_MKNOD3args) -> client.UnpackedRPCMsg[v_MKNOD3res]:
        return await self.send_call(11, arg_0)

    async def REMOVE(self, arg_0: v_REMOVE3args) -> client.UnpackedRPCMsg[v_REMOVE3res]:
        return await self.send_call(12, arg_0)

    async def RMDIR(self, arg_0: v_RMDIR3args) -> client.UnpackedRPCMsg[v_RMDIR3res]:
        return await self.send_call(13, arg_0)

    async def RENAME(self, arg_0: v_RENAME3args) -> client.UnpackedRPCMsg[v_RENAME3res]:
        return await self.send_call(14, arg_0)

    async def LINK(self, arg_0: v_LINK3args) -> client.UnpackedRPCMsg[v_LINK3res]:
        return await self.send_call(15, arg_0)

    async def READDIR(self, arg_0: v_READDIR3args) -> client.UnpackedRPCMsg[v_READDIR3res]:
        return await self.send_call(16, arg_0)

    async def READDIRPLUS(self, arg_0: v_READDIRPLUS3args) -> client.UnpackedRPCMsg[v_READDIRPLUS3res]:
        return await self.send_call(17, arg_0)

    async def FSSTAT(self, arg_0: v_FSSTAT3args) -> client.UnpackedRPCMsg[v_FSSTAT3res]:
        return await self.send_call(18, arg_0)

    async def FSINFO(self, arg_0: v_FSINFO3args) -> client.UnpackedRPCMsg[v_FSINFO3res]:
        return await self.send_call(19, arg_0)

    async def PATHCONF(self, arg_0: v_PATHCONF3args) -> client.UnpackedRPCMsg[v_PATHCONF3res]:
        return await self.send_call(20, arg_0)

    async def COMMIT(self, arg_0: v_COMMIT3args) -> client.UnpackedRPCMsg[v_COMMIT3res]:
