# Auto-generated at Tue, 16 Jun 2020 15:49:39 +0000 from pynefs/idl/rfc1831.x
...
reply_data = rpchelp.union('reply_data', accept_stat, {SUCCESS: rpchelp.r_void, PROG_MISMATCH: mismatch_info, None: rpchelp.r_void})
...
rejected_reply = rpchelp.union('rejected_reply', reject_stat, {RPC_MISMATCH: rejected_reply_mismatch_info, AUTH_ERROR: auth_stat})
reply_body = rpchelp.union('reply_body', reply_stat, {MSG_ACCEPTED: accepted_reply, MSG_DENIED: rejected_reply})
rpc_body = rpchelp.union('rpc_body', msg_type, {CALL: call_body, REPLY: reply_body})
...
class v_accepted_reply(rpchelp.struct_val_base):
	verf: v_opaque_auth
	data: typing.Tuple[int, typing.Union[None, v_mismatch_info, None]]
...
class v_rpc_msg(rpchelp.struct_val_base):
	xid: int
	body: typing.Tuple[int, typing.Union[v_call_body, typing.Tuple[int, typing.Union[v_accepted_reply, typing.Tuple[int, typing.Union[v_rejected_reply_mismatch_info, int]]]]]]
